...
# Group by Year wise sum of Medal
    if flag == 1:
...
def data_over_time(df,col):
    ...
    nation_overtime.rename(columns={'index': 'Edition', 'Year': col}, inplace=True)
...
# Country wise medal represent by year
...
# Man vs Women participation over years
def men_v_women(df):
    athlete_df = df.drop_duplicates(subset=['Name','region'])
